...
Pod::Spec.new do |s|
  s.name             = 'AzureIoTuMqtt-Clone'
  s.version          = ENV['mqtt_ver']
  s.summary          = 'AzureIoTuMqtt library for CocoaPods.'

  s.description      = <<-DESC
This is a CocoaPods release of the Azure C uMQTT library.
                       DESC

  s.homepage         = 'https://github.com/Azure/azure-iot-sdk-c/blob/master/doc/sdk_cocoapods.md'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Microsoft' => '' }
  s.source           = { :git => 'https://github.com/Azure/azure-umqtt-c.git'}#, :tag => ENV['mqtt_ver'] }
  ...
  s.prepare_command = <<-CMD
    ...
    pushd inc > /dev/null
    echo "module AzureIoTuMqtt-Clone [system][extern_c] {" > module.modulemap
    quote_thing='\"'
 ...
 # s.public_header_files = 'inc/**/*.h'
  ...
  s.xcconfig = {
    ...
    'USE_HEADERMAP' => 'NO',
    'USER_HEADER_SEARCH_PATHS' => '"${PODS_ROOT}/AzureIoTUtility-Clone/inc/" "${PODS_ROOT}/AzureIoTuMqtt-Clone/inc/"',
    'HEADER_SEARCH_PATHS' => '"${PODS_ROOT}/AzureIoTUtility-Clone/inc/" "${PODS_ROOT}/AzureIoTuMqtt-Clone/inc/"',
